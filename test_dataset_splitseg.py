...
from utils.dataset_splitseg import HybridDataset, ValDataset, collate_fn_splitseg
...
if __name__ == "__main__":
    ...
    conda activate lisa
    deepspeed  --include=localhost:2  --master_port=24999 test_dataset_splitseg.py \
